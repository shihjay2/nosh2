...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_js_sha3__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_buffer__ = __webpack_require__(1);
...
/* harmony export (immutable) */ __webpack_exports__["isMNID"] = isMNID;
...
function checksum (payload) {
  return new __WEBPACK_IMPORTED_MODULE_1_buffer__["Buffer"](__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_js_sha3__["sha3_256"])(__WEBPACK_IMPORTED_MODULE_1_buffer__["Buffer"].concat(payload)), 'hex').slice(0, 4)
}

function encode ({network, address}) {
  const payload = [new __WEBPACK_IMPORTED_MODULE_1_buffer__["Buffer"]('01', 'hex'), hex.decode(network.slice(2)), new __WEBPACK_IMPORTED_MODULE_1_buffer__["Buffer"](address.slice(2), 'hex')]
  payload.push(checksum(payload))
  return base58.encode(__WEBPACK_IMPORTED_MODULE_1_buffer__["Buffer"].concat(payload))
}

function decode (encoded) {
  const data = __WEBPACK_IMPORTED_MODULE_1_buffer__["Buffer"].from(base58.decode(encoded))
