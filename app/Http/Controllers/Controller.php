    ...
    */
    ...
    protected function form_addressbook($result, $table, $id, $subtype)
    {
        ...
        if ($subtype == 'faxonly') {
            ...
            if ($subtype == 'Laboratory' || $subtype == 'Radiology' || $subtype == 'Cardiopulmonary' || $subtype == 'Pharmacy') {
    ...
    protected function github_all()
    {
        ...
        $result = $client->api('repo')->commits()->all('shihjay2', 'nosh2-core', ['sha' => 'master']);
        return $result;
    }
    ...
    protected function github_single($sha)
    {
        ...
        $client = new \Github\Client($client);
        $result = $commit = $client->api('repo')->commits()->show('shihjay2', 'nosh2-core', $sha);
        return $result;
    }
