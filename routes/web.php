...
Route::any('practice_cancel/{id?}', ['as' => 'practice_cancel', 'uses' => 'CoreController@practice_cancel']);
Route::any('practice_create', ['as' => 'practice_create', 'uses' => 'CoreController@practice_create']);
Route::any('practice_logo_upload', ['as' => 'practice_logo_upload', 'uses' => 'CoreController@practice_logo_upload']);
Route::get('practice_manage/{type}', ['as' => 'practice_manage', 'uses' => 'CoreController@practice_manage']);
Route::get('practice_reactivate/{id}', ['as' => 'practice_reactivate', 'uses' => 'CoreController@practice_reactivate']);
...
Route::get('print_schedule', ['as' => 'print_schedule', 'uses' => 'CoreController@print_schedule']);
...
Route::get('setup/{practice_id?}', ['as' => 'setup', 'uses' => 'CoreController@setup']);
...
Route::any('user_copy/{id}', ['as' => 'user_copy', 'uses' => 'CoreController@user_copy']);
Route::get('users/{type}/{active}/{practice_id?}', ['as' => 'users', 'uses' => 'CoreController@users']);
...
Route::get('cms_bluebutton_disconnect', ['as' => 'cms_bluebutton_disconnect', 'uses' => 'ChartController@cms_bluebutton_disconnect']);
...
Route::get('patient_data_export', ['as' => 'patient_data_export', 'uses' => 'ChartController@patient_data_export']);
